...
This is hard work up-front but but makes programming much easier so for for
complex databases it pays off.
...
* `flatten_linked_tables()` flattens all linked tables in a single one.
...
in complex databases it's hard work.
